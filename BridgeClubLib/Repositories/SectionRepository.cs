...
namespace BridgeClubLib.Repositories
{
	public class SectionRepository
	{
		...
		private string selectSql = "SELECT S.ID AS SECTIONID, G.ID AS GROUPTOURNAMENTID, G.FKMAINTOURNAMENTID AS MAINTOURNAMENTID, S.SECTIONNO, S.STARTTIME, S.ENDTIME, S.STARTROUNDNO, S.ENDROUNDNO, S.WAVESTARTINDEX, S.WAVELENGTH, S.WAVEEQWAVEINDEX, S.PAYMENTSTATUS, S.SECTIONSCOREVALID, S.TOTALSCOREVALID FROM GROUPTOURNAMENT G JOIN SECTION S ON G.ID = S.FKGROUPTOURNAMENTID WHERE G.FKMAINTOURNAMENTID = @MAINTOURNAMENTID";
